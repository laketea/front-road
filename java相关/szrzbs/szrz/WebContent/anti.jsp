		...
		<div class="main_right r">
			<div class="main_title">
				当前位置：首页 <label class="nav_sep_color"> &gt;&gt; </label><label
					class="nav_has_no_link">防伪认证</label><label class="nav_sep_color"> &gt;&gt; </label><label
					...
					<tbody>
						<tr>
							<td align="left" class="about-content"><
								...
								<s:form
									action="antiImg!upload.action" method="post"
									...
									<input type="hidden" name="type" value="${type}" >
										<tr>
											<td width="90px">名称</td>
											<td><input type="text" name="anti.imgName">
											</td>
										</tr>
										<tr>
											<td>类型</td>
											<td><select name="anti.typeId">

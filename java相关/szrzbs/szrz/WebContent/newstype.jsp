...
<div class="main">
    ...
    <div class="main_right r">
        <div class="main_title">当前位置：首页 <label class="nav_sep_color"> &gt;&gt; </label><label class="nav_has_no_link">新闻动态</label><label class="nav_sep_color"> &gt;&gt; </label><label class="nav_has_no_link">${newsType.name}</label>
           </div>

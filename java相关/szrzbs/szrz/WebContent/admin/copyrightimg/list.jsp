    ...
    <table class="table" width="100%" layoutH="138" >  
        ...
        <tbody>  
            ...
            <tr target="copyRightImg_uid" rel="${item.id}" >  
				...
				<td>${item.status}</td>
				<td>
					<a title="删除" target="ajaxTodo" href="/szrz/admin/copyRightImg!delete.action?id=${item.id}" class="btnDel">删除</a>
					<a title="编辑" target="dialog" href="/szrz/admin/copyRightImg!edit.action?id=${item.id}" class="btnEdit">编辑</a>
				</td>

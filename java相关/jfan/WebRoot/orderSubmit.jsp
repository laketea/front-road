...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="50"></td>
    <td height="50"><img src="images/tg_cart1.gif" width="397" height="34" /></td>
    <td height="50"></td>
  </tr>
  <tr>
    <td height="10"></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="1000" align="center" valign="top" id="main"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tr>
	  ...
	  <%
		...
		if(ci==null){
			%>
			<tr><td height="35"   colspan="7">&nbsp;&nbsp;&nbsp;&nbsp;购物车中没有商品！！</td></tr>
			<% 
			}else {

...
<%
	...
	if(search!=null) {search = new String(request.getParameter("search").getBytes("ISO-8859-1"),"gb18030");}
	GodsService godsservice = new GodsService();
	//Gods topgods = godsservice.getTopGods();
	Gods sgods = new Gods();
	sgods.setName(search);
	List result = godsservice.getSearchListByPage( sgods ,50,1);
	int searchcout = godsservice.getSearchGodsCount(sgods);
	Date now = new Date();
	...
	<% UserService services = new UserService();
      ...
      <tr>
       ...
       <tr>
        ...
        <td width="948" height="35" align="left" valign="middle"><span style="font-size:12pt; color:#61861e;" >“<%=search%>”搜索结果(<%=searchcout%>)</span></td>
...
Gods gods  =(Gods)result.get(i);
		  %>
            ...
            <td width="300" height="346" align="center" valign="top"><table width="300" border="0" cellpadding="0" cellspacing="0" class="de_table">
              <tr>
                <td height="220" colspan="2" align="center" valign="bottom"><a  href="godsDetail.jsp?ids=<%=gods.getId()%>" ><img src="files/<%=gods.getMinphoto()%>" width="268" height="207" border="0" /></a></td>
              </tr>
              <tr>
                <td height="45" colspan="2" align="center" valign="middle"><a class="gods_list_name" href="godsDetail.jsp?ids=<%=gods.getId()%>" ><%=gods.getName()%></a></td>
              </tr>
...
src="temaizhou.js"></script>				</td>
			...
			if(result.size()==2&&i==1){%>
			 <td width="300" height="346" align="center" valign="top"><img  width="280" src="images/tg_df_zwf2.png" /></td>
      ...
      <tr>
        <td colspan="3" height="20" align="right">                   </td>
      </tr>
    </table></td>
    <td>&nbsp;</td>
  </tr>

...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="1000" height="200" align="center" valign="top" ><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
	...
	<% UserService services = new UserService();
      ...
      <tr>
        <td height="300" rowspan="14" width="16" align="center" valign="top">&nbsp;</td>
        <td width="470" height="500" rowspan="6" align="center" valign="top" ><table width="400" height="500" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td class="de_table"><img src="<%=topgods.getMaxphoto()%>" width="400" height="400" border="0" id="img_hit" /></td>
          </tr>
		  <tr><td height="100" align="left"><a href="#"onmouseover="document.getElementById('img_hit').src ='<%=topgods.getMaxphoto()%>'"><img src="<%=topgods.getMaxphoto()%>" width="65" height="65" border="0" /></a>&nbsp;
		  <%if(!"0".equals(topgods.getMaxphoto_a())&&topgods.getMaxphoto_a()!=null){%> <a href="#"onmouseover="document.getElementById('img_hit').src ='<%=topgods.getMaxphoto_a()%>'"><img src="<%=topgods.getMaxphoto_a()%>" width="65" height="65" border="0" /></a>&nbsp;<%}%>
		   <%if(!"0".equals(topgods.getMaxphoto_b())&&topgods.getMaxphoto_b()!=null){%><a href="#"onmouseover="document.getElementById('img_hit').src ='<%=topgods.getMaxphoto_b()%>'"><img src="<%=topgods.getMaxphoto_b()%>" width="65" height="65" border="0" /></a>&nbsp;<%}%>
		    <%if(!"0".equals(topgods.getMaxphoto_c())&&topgods.getMaxphoto_c()!=null){%><a href="#"onmouseover="document.getElementById('img_hit').src ='<%=topgods.getMaxphoto_c()%>'"><img src="<%=topgods.getMaxphoto_c()%>" width="65" height="65" border="0" /></a>&nbsp;<%}%>
			 <%if(!"0".equals(topgods.getMaxphoto_d())&&topgods.getMaxphoto_d()!=null){%><a href="#"onmouseover="document.getElementById('img_hit').src ='<%=topgods.getMaxphoto_d()%>'"><img src="<%=topgods.getMaxphoto_d()%>" width="65" height="65" border="0" /></a>&nbsp;<%}%>
		   </td></tr>
        </table></td>
        <td width="35" height="500" rowspan="6" align="center" valign="top" ></td>
        <td width="440" align="center" valign="top" ></td>
        <td rowspan="14" align="center" valign="top" width="16">&nbsp;</td>
      </tr>
      <tr>
			...
			<table width="365" height="177" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="88" align="center" valign="middle" bgcolor="#B0C983" class="de_gods_1" style=" font-size:16pt; color:#663300;">我要买
                  <input type="button" value="-" style="border-width: 1px;border-style: solid;border-color: #FFFFFF; background-color:#B0C983; color:#ffffff; width:25px; height:20px; font-size:16px; line-height:20px;vertical-align:middle;display:inline;text-align:center; margin-right:5px;" onclick="jian()"  /><input type="text" name="count" style="border-width: 1px;border-style: solid;border-color: #FFFFFF; background-color:#B0C983; color:#ffffff; width:45px; height:25px; font-size:16px; line-height:25px; text-align:center;vertical-align:middle;display:inline;padding:0;" value="1" id="number"  /><input type="button" value="+" style="border-width: 1px;border-style: solid;border-color: #FFFFFF; background-color:#B0C983; color:#ffffff; width:25px; height:20px; font-size:16px; line-height:20px;vertical-align:middle;display:inline;text-align:center; margin-left:5px;" onclick="add()"  /></td>
              </tr>
			  <tr>
              ...
              <tr>
				...
				&nbsp;<input type= "button" value= "" onclick="cartsubmit()" name= "B1 " style= "cursor: hand; background-image:url( 'images/tg_dte_1.png');width: 123px; height: 31px;border-style:none; ">				</td>
              </tr>
            </table>
			</form>			</td>
          </tr>
      ...
      <tr>
        <td height="20" colspan="3" align="left" valign="bottom" >&nbsp;</td>
      </tr>
      <tr>
        <td height="30" colspan="3" align="left" valign="bottom" class="review_add_viewbt"><div style="background-color:#61861E; width:100px; height:30px; font-size:16px; font-family:'微软雅黑'; color:#FFFFFF; text-align:center; line-height:30px">全部评论</div></td>
      </tr>
	 
      <tr>
        <td height="50" colspan="3" align="center" valign="top" >
		<iframe id="frame_content" src="reviewiframe.jsp?id=<%=ids%>" width="940px" scrolling="no" frameborder="0" onload="this.height=this.contentWindow.document.documentElement.scrollHeight"></iframe>

		</td>
      </tr>
      <tr>
        <td height="10" colspan="3" align="center" valign="top" class="review_add_viewbt">&nbsp;</td>
      </tr>
...
<script language="javascript">
function add(){
 var nbs = parseFloat(document.getElementById("number").value);
 var totalprice = 0;
 totalprice = nbs+1;
 document.getElementById("number").value =totalprice; 

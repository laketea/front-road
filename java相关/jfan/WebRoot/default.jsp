...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="1000" height="200" align="center" valign="top" id="main">
	  ...
	  <tr>
        ...
        <td width="598" height="42" align="left" valign="middle" bordercolor="#0033CC"><div id="mid_menu">
	<ul>
	...
	<% UserService services = new UserService();
        ...
        <td width="318" height="42" align="right" valign="middle"><input type="text" name="search" class="search_input"  /><input type="submit" value="搜索" class="search_button"  /></td>
	  </tr>
	 </form>
      <tr>
      ...
      <tr>
        <td height="374" align="center" valign="top"><table width="948" border="0" cellpadding="0" cellspacing="0" class="de_table">
          <tr>
            <td height="129" colspan="3" align="left" valign="top" style=" padding-left:10px; padding-top:10px;"><span style="font-size: 24px;color: #638721;font-family:微软雅黑;">今日团购推荐：</span><span style=" line-height:35px;"><a class="top_goods_name"   href="godsDetail.jsp?ids=<%=topgods.getId()%>" ><%=topgods.getDiscript() %></a></span></td>
          </tr>
          <tr>
  ...
  <tr>
	...
	<%if(topgods.getHourcount()==0){%>抢光了<% } else{ if((topgods.getEnddate()).getTime()>nowLong)  {%><a href="<%=request.getContextPath()%>/cartAction.do?method=add&amp;bookid=<%=topgods.getId()%>" title="立即购买"><img src="images/tg_d_qg.png"  border="0" align="middle" /></a>
    ...
    <td width="70" align="center" valign="middle"><img src="images/yuan.png"  /></td>
              ...
              <tr>
                <td height="265" align="left" valign="top"><table width="275" border="0" cellpadding="0" cellspacing="0" class="de_df_table">
                  ...
                  <tr>
                    ...
                    <td height="40" align="center"  valign="middle"  style="font-family:'宋体'; font-size:10pt; color:#6F9132;" >￥ <%=Arith.sub(topgods.getOldprice(),topgods.getNewprice())%></td>
                  </tr>
                  <tr>
            ...
            <td width="585px" height="380" class="de_table"><a  href="godsDetail.jsp?ids=<%=topgods.getId()%>" ><img src="<%=topgods.getMinphoto()%>" width="585px" height="380px" border="0" /></a></td>

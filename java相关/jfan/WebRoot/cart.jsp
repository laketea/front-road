  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tr>
		...
		<form action="cartAction.do?method=update&amp;Godsid=<%=cartItem.getGods().getId()%>" method="post" name="cartForm">
          <tr >
            ...
            <td height="105" align="left" valign="middle" class="cart_bottom"   >&nbsp;&nbsp;<img src="<%=cartItem.getGods().getMinphoto()%>" width="100" height="60" align="absmiddle" />&nbsp;&nbsp;<%=cartItem.getGods().getName()%></td>
      ...
      <tr>
        ...
        <td height="110" align="center">&nbsp;</td>
        <td height="110" colspan="2" align="center"><a href="default.jsp"><img src="images/tg_cart_2.gif" width="89" height="35" border="0" /></a><a href="orderAction.do?method=cklogin"><img src="images/tg_cart_3.gif" width="95" height="35" border="0" /></a></td>
        <td height="110">&nbsp;</td>
      </tr>
    </table>

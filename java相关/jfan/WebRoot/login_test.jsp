...
$(document).ready(function(){	
    $("#me").focus(function(){ //文本框获得焦点，插入Email提示层
        $("#myemail").remove();
	$(this).after("<div id='myemail' style='width:170px; height:auto; background:#fff; color:#6B6B6B; position:relative;left:"+$(this).get(0).offsetLeft+"px; top:"+($(this).get(0).offsetTop+$(this).height()+2)+"px; border:1px solid #ccc;z-index:5px; '></div>");
        if($("#myemail").html()){
		  ...
		  <table width="448" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			...
			<%  } %>
              ...
              <tr>
                ...
                <td width="312" height="30"><input type="text" id="me" name="name2" style="width:250px; height:30"   /></td>
              </tr>
              <tr>

 ...
 %>
		...
		<table width="750" cellpadding="2" cellspacing="1" class="TablePanel" >
			...
			<tr>
			  ...
			  <td width="663" class="STYLE1">
			  	<select name="defaultstatus" >
					...
					<option value="0" <%if(gods.getDefaultstatus()==0){%> selected="selected" <%}%> >否</option>
					<option value="1" <%if(gods.getDefaultstatus()==1){%> selected="selected" <%}%>>是</option>
				</select><span class="redhat">*</span> 
				&nbsp;&nbsp;&nbsp;&nbsp;置顶推荐：<select name="firststatus" >
					<option value="">请选择&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
					<option value="0"  <%if(gods.getFirststatus()==0){%> selected="selected" <%}%> >否</option>
					<option value="1"  <%if(gods.getFirststatus()==1){%> selected="selected" <%}%> >是</option>
				</select> <span class="redhat">*</span> 
			...
			<tr>
			  ...
			  <td width="663" class="STYLE1">
			  	<select name="status" >
					...
					<option value="0" <%if(gods.getStatus()==0){%> selected="selected" <%}%>  >销售</option>
					<option value="1"  <%if(gods.getStatus()==1){%> selected="selected" <%}%>  >下架</option>
				</select><span class="redhat">*</span> 
			...
			<tr>
			  ...
			  <td width="663" class="STYLE1"> <html:hidden property="types"  value="<%=gods.getFirst().toString()%>"/><%=gods.getFirstname()%><span class="redhat">*</span>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				积分：<html:text property="point" value="<%=gods.getPoint().toString()%>"   size="20"/><span class="redhat">*</span>
			  </td>
			</tr>
			<tr>
			  <td width="74" align="right" class="STYLE1">库存：</td>
			  <td width="663" class="STYLE1"> <html:text property="hourcount"  size="56" value="<%=gods.getHourcount().toString()%>"/><span class="redhat">*</span></td>
			</tr>
			<tr>
...
结束时间：<input value="<%=gods.getEnddate().toString()%>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'begin_time\')}'})"
			...
			<tr>
			  ...
			  <td width="663" class="STYLE1">
			  	<input type="text" name="pt_m" size="50" value="<%=gods.getMinphoto()%>" ><span class="redhat">*</span> 
			  </td>
			</tr>
			<tr>
			  <td width="74" align="right" class="STYLE1">大图：<br></td>
			  <td width="663" class="STYLE1">
			  	<input type="text" name="pt_ma" size="50" value="<%=gods.getMaxphoto()%>" ><span class="redhat">*</span> 
			  </td>
			</tr>
			<tr>
			  <td width="74" align="right" class="STYLE1">图一：<br></td>
			  <td width="663" class="STYLE1">
			  	<input type="text" name="pt_a" size="50" value="<%=gods.getMaxphoto_a()%>" ><span class="redhat">*</span> 
			  </td>
			</tr>
			<tr>
			  <td width="74" align="right" class="STYLE1">图二：<br></td>
			  <td width="663" class="STYLE1">
			  	<input type="text" name="pt_b" size="50" value="<%=gods.getMaxphoto_b()%>" ><span class="redhat">*</span> 
			  </td>
			</tr>
			<tr>
			  <td width="74" align="right" class="STYLE1">图三：<br></td>
			  <td width="663" class="STYLE1">
			  	<input type="text" name="pt_c" size="50" value="<%=gods.getMaxphoto_c()%>" ><span class="redhat">*</span> 
			  </td>
			</tr>
			<tr>
			  <td width="74" align="right" class="STYLE1">图四：<br></td>
			  <td width="663" class="STYLE1">
			  	<input type="text" name="pt_d" size="50" value="<%=gods.getMaxphoto_d()%>" ><span class="redhat">*</span> 
			  </td>
			</tr>
			<tr>
